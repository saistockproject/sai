...
<body>
	...
	<aside id="sidebar" class="column"> 
		<form:form class="quick_search"  modelAttribute="stockSearchForm" action="searchStocks" method="post">
			 <form:input path="searchCriteria" type="text" class="input- ui-autocomplete-input"
